...
$('#color').val(color)
  ...
  $(`.bg-grad-main`).removeClass(`bg-gradient-${$('.bg-grad-main').data('color')}`);
  $(`.bg-grad-main`).data(`color`,color);
  $('.main-bg-color').css('background-color',`var(--bs-${color})`);
  $('.main-text-color').css('color',`var(--bs-${color})`);
  $(':root').css('--main-grad',`var(--gradient-${color})`);
  let color1=$('.main-text-color').css('color');
  $(':root').css('--main-theme-color',`var(--bs-${color})`);
}
...
function sidebarType(a) {
  ...
  for (var i = 0; i < parent.length; i++) {
    parent[i].classList.remove('active');
    parent[i].classList.remove(`bg-grad-main`);
    parent[i].classList.remove(`btn-outline-${color}`);
  }

  if (!a.classList.contains('active')) {
    a.classList.add('active');
    a.classList.remove(`btn-outline-${color}`);
    a.classList.add(`bg-grad-main`);
  } else {
    a.classList.remove('active');
    a.classList.add(`btn-outline-${color}`);
    a.classList.remove(`bg-grad-main`);
