...
<main id="main_content" class="main-content">
    <div  class="container-fluid mb-4">
        <div class="animate__animated animate__fadeInDown page-header min-height-300 border-radius-xl mt-4" style="background-image: url('http://localhost/mypkl/vendor/assets/img/curved-images/curved0s.jpg'); background-position-y: 50%;">
                        ...
                        <div class="card-body pt-sm-3 pt-0">
                            ...
                            <div class="row justify-content-evenly">
                                <div class="col">
                                    ...
                                    <div href="javascript:void(0)" class="switch-trigger background-color">
                                        <div class="badge-colors my-2 text-start">
                                            <span class="badge filter bg-gradient-primary <?php if($color=='primary'){echo 'active';}?>" onclick="sidebarColor(`primary`);$(this).addClass('active');$(this).siblings().removeClass('active')"></span>
                                            <span class="badge filter bg-gradient-dark <?php if($color=='dark'){echo 'active';}?>" onclick="sidebarColor(`dark`);$(this).addClass('active');$(this).siblings().removeClass('active')"></span>
                                            <span class="badge filter bg-gradient-info <?php if($color=='info'){echo 'active';}?>" onclick="sidebarColor(`info`);$(this).addClass('active');$(this).siblings().removeClass('active')"></span>
                                            <span class="badge filter bg-gradient-success <?php if($color=='success'){echo 'active';}?>" onclick="sidebarColor(`success`);$(this).addClass('active');$(this).siblings().removeClass('active')"></span>
                                            <span class="badge filter bg-gradient-warning <?php if($color=='warning'){echo 'active';}?>" onclick="sidebarColor(`warning`);$(this).addClass('active');$(this).siblings().removeClass('active')"></span>
                                            <span class="badge filter bg-gradient-danger <?php if($color=='danger'){echo 'active';}?>" onclick="sidebarColor(`danger`);$(this).addClass('active');$(this).siblings().removeClass('active')"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    </div> <span><h6 class="mb-0 ms-2">Navbar Statis </h6></span>
                                    </div>
