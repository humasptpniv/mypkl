<main class="main-content" id="main_content">
    ...
    <div class="container-fluid d-flex justify-content-center">
        <div data-aos='zoom-in' data-aos-duration="1200" style="position: relative;z-index:2" class="d-flex flex-column">
                    ...
                    <form role="form" method="post" action="<?= base_url('index.php/') ?>user/ajukan_surat">
                        <div class="row">
                            ...
                            <div class="col-sm-11 col-md-6 col-lg-6">
                                ...
                                <div class="mb-3">
                                    <input type="number" class="form-control" name="nim_nisn" required>
                                </div>
                            </div>
                            <div class="col-sm-11 col-md-6 col-lg-6">
                            ...
                            <div class="col-sm-11 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="jur" required>
                                </div>
                            </div>
                            <div class="col-sm-11 col-md-6 col-lg-6">
                                <div class="mb-3">
