<main id="main_content" style="transition: all linear 200ms;" class="main-content position-relative max-height-vh-100 h-100  border-radius-lg ">
  ...
  <div class="container-fluid">
    <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('http://localhost/mypkl/vendor/assets/img/curved-images/curved0.jpg'); background-position-y: 50%;">
